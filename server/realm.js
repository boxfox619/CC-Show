...
const AssetSchema = {
    ...
    properties: {
        ...
        thumbnails: {type: 'list', objectType: 'Thumbnail'},
...
const ShowSchema = {
    ...
    properties: {
        ...
        slides: {
            type: 'string',
            default: '[{"name":"TEST-SLIDE","id":0,"thumbnail":"","note":"","assetIdCount":0,"assets":[]}]'
        }
    }
}

const realm = new Realm({schema: [UserSchema, AssetSchema, ShowSchema, ThumbnailSchema, TagSchema]});
