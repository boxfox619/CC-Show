  ...
  render(){
    return (
      <div onClick={()=>this.props.onClick(this.props.slide)} className={styles.slidePreview+' '+((this.props.active)?styles.active:'')}>
        <div className={styles.thumbnail}><div className={styles.content} style={(this.props.slide.thumbnail!=undefined)?{'backgroundImage':'url('+this.props.slide.thumbnail+')'}:{}}/></div>
