...
const propTypes = {
  ...
  textLineSpacing: React.PropTypes.string.isRequired,
  setAssetFontWeight: React.PropTypes.string.isRequired
}
        ...
        <div className={styles.items}>
          <div>
            <div>
              ...
              <div className={styles.control_item}>
                <input className={styles.attribute_item_input}
                  onChange={this.setFontWidth}
                  type="text"
                  value={this.getFontWidth()}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className={styles.control_item}>
                <span className={styles.attribute_item_title}><img onClick={() => this.props.setAssetTextLineSpacing('normal')}
            ...
            <div>
              ...
              <div className={styles.control_item}>
                ...
                <div className={styles.change_color}
                  ...
                  style={this.getTextColor() === 'black' ? {border: '1px solid #5D87B5'} : {backgroundColor: this.getTextColor()}}
                />
              </div>
            </div>
