            ...
            <div>
                <div>
                    <div className={styles.controller_sub_wrapper}>
                        ...
                        <img onclick={this.attributeOn()} src="/images/ic_arrow_up.png" style={this.state.attribute_arrow_up ? {display:'block'} : {display:'none'}} className={styles.show_items_button}/>
                        <img onclick={this.attributeOff()} src="/images/ic_arrow_down.png" style={this.state.attribute_arrow_down ? {display:'block'} : {display:'none'}} className={styles.show_items_button}/>
                        </div>
                    </div>
                ...
                <div>
                    <div className={styles.controller_sub_wrapper}>
                            <div className={styles.controller_sub_title}>도형
                                <img onclick={this.shapeOn()} src="/images/ic_arrow_up.png" style={this.state.shape_arrow_up ? {display:'block'} : {display:'none'}} className={styles.show_items_button}/>
                                <img onclick={this.shapeOff()} src="/images/ic_arrow_down.png" style={this.state.shape_arrow_down ? {display:'block'} : {display:'none'}} className={styles.show_items_button}/>
                            </div>
                    </div>
                ...
                <div>
                    <div className={styles.controller_sub_wrapper}>
                        <div className={styles.controller_sub_title}>스타일
                            <img onclick={this.styleOn()} src="/images/ic_arrow_up.png" style={this.state.style_arrow_up ? {display:'block'} : {display:'none'}} className={styles.show_items_button}/>
                            <img onclick={this.styleOff()} src="/images/ic_arrow_down.png" style={this.state.style_arrow_down ? {display:'block'} : {display:'none'}} className={styles.show_items_button}/>
                        </div>
                    </div>
